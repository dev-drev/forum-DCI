...
export default function EditProfForm(props) {
  ...
  const onSaveUpdatesHandler = (e) => {
    ...
    axios("http://localhost:5000/admin/edit", {
      method: "PATCH",
      data: { editedUser },
    })
      .then((data) => {
    ...
    <div className="w-72 flex justify-center">
      <form onChange={changeHandler} onSubmit={props.onSave}>
        ...
        <div className="flex-row p-10">
          <button
            onClick={onSaveUpdatesHandler}
            className="bg-green text-white h-10 px-5 m-2 rounded-lg"
            type="submit"
          >
            Save
          </button>
          <button
            ...
            className="bg-gray-200 text-gray-700 h-10 px-5 m-2 rounded-lg"
            type="button"
          >
            Cancel
          </button>
