        ...
        return (
            <>
                ...
                <div className="bg-gray-100">
                    <div
                        className="w-full h-16 bg-gradient-to-r from-gray-800 to-primary  border-gray-200 shadow-xl"></div>
                    ...
                    <div className="w-10/12 md:h-auto lg:h-screen m-auto bg-white">
                        ...
                        <div
                            className="grid lg:grid-cols-4 md:grid-cols-2 justify-items-center gap-y-5 mt-16 pb-10 mr-12 ml-10">
